...
| `kanban_submit_review` | Close implementation evidence into `review` and assign an independent reviewer. | `reviewer`, `summary` |
| `kanban_review_changes` | Finish a review with findings and create a remediation card for the original implementer. | `summary` |
