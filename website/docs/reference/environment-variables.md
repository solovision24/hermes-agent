...
| `HERMES_ROOT` | Explicit shared Hermes installation root used when `HERMES_HOME` points at a profile or temporary bridge. Keeps shared auth, credential pools, and Kanban assets on the canonical root; intended for launchers that create isolated profile homes |
