...
KANBAN_GUIDANCE = (
    ...
    "For code changes, preserve the structured handoff in the completion "
    "metadata and follow the native Kanban Review lifecycle for human review "
    "before merge. Do not use a blocked task as a substitute for Review.\n"
