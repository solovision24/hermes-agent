...
KANBAN_GUIDANCE = (
    ...
    "Exception: code changes needing review should use "
    "`kanban_submit_review` when a real reviewer and immutable PR evidence "
    "(pr_url, repo, number, head_sha, verification_evidence) exist. "
    "Otherwise put changed_files / tests_run / diff_path in a "
